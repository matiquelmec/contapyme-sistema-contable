-- =====================================================
-- MIGRACIÓN SEGURA: Agregar campos para generación de contratos
-- Fecha: 2025-08-13
...
-- =====================================================
-- PASO 7: CREAR VISTA PARA CONTRATOS COMPLETOS
-- =====================================================
...
SELECT 
    ...
    pc.afp_name,
    pc.health_insurance_name,
    pc.health_insurance_type
...
CREATE POLICY "Contract templates visible for company" ON contract_templates
    FOR ALL USING (company_id IN (
        SELECT id FROM companies WHERE id = '8033ee69-b420-4d91-ba0e-482f46cd6fce'
        UNION
...
SELECT 'Migración de campos de contratos completada exitosamente' as status;
