-- =============================================
-- MIGRACIÓN CORREGIDA SISTEMA CONTABLE MULTI-LÍNEA
-- Fecha: 6 de agosto, 2025  
-- Descripción: Corrección del orden de ejecución de constraints y triggers
-- =============================================
...
-- =======================
-- 7. FUNCIÓN PARA ACTUALIZAR TOTALES (SIN TRIGGER)
-- =======================
...
BEGIN
    ...
    -- Actualizar sin constraint activo
    UPDATE journal_book
    SET 
...
-- =======================
-- 8. FUNCIÓN PRINCIPAL PARA CREAR ASIENTOS (SIN TRIGGERS AUTOMÁTICOS)
-- =======================
...
BEGIN
    ...
    -- Crear encabezado CON TOTALES CORRECTOS DESDE EL INICIO
    ...
    -- Crear TODAS las líneas en bloque
    FOR v_line IN SELECT * FROM jsonb_array_elements(p_entry_lines)
    LOOP
...
-- =======================
-- 9. CREAR TRIGGER PARA MANTENIMIENTO FUTURO
-- =======================
...
BEGIN
    -- Solo actuar si la operación es sobre journal_book_details
    ...
    -- Actualizar totales (esto ahora funcionará porque el constraint se aplica después)
...
-- Crear el trigger PERO como AFTER para evitar conflictos con constraints
...
-- =======================
-- 11. CREAR ASIENTOS DE EJEMPLO (SIN CONSTRAINTS AÚN)
-- =======================
...
-- =======================
-- 12. AHORA SÍ AGREGAR CONSTRAINT (DESPUÉS DE LOS EJEMPLOS)
-- =======================

-- Solo agregar constraint DESPUÉS de que los ejemplos estén balanceados
...
SELECT 'SISTEMA CONTABLE MULTI-LÍNEA - CONSTRAINT APLICADO CORRECTAMENTE' AS resultado;